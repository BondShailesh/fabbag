...
function CommonProduct() {
    ...
    const handleSubmit = () => {
        alert(`${item} item is added to the cart`)
        cartdispatch({
            type: "addCart",
            payload: {
                title: data.title,
        ...
        <Box>
            <Flex className={styles.SubscribeContainer}>
                ...
                <Box>
                    ...
                    <Box _hover={{ cursor: "pointer", background: "rgb(230,187,101)" }} onClick={handleSubmit} className={styles.cartbutton}>ADD TO CART</Box>
                    {/* _hover={{ cursor: "pointer",backgroundColor:"" }} */}
                    <Box className={styles.subsicon} mt="19px" color="grey">
                        <Box _hover={{ cursor: "pointer", color: "rgb(230,187,101)" }}>  <BsTwitter size="27" /> </Box>
                        <Box _hover={{ cursor: "pointer", color: "rgb(230,187,101)" }}><BsFacebook size="22" /> </Box>
                        <Box _hover={{ cursor: "pointer", color: "rgb(230,187,101)" }}><BsGoogle size="22" /> </Box>
                    </Box>
                </Box>
            </Flex>
